...
Esto se puede evidenciar en los logs, donde primero aparecen los mensajes de: fallo número 1, fallo número 2, fallo número 3 y posteriormente:
“Circuito abierto debido a fallos repetidos en el backend”.
